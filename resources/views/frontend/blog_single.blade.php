...
@section('meta')
    <title>Blog Details - Institute of Healthcare Development</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="block text-center">
                        <h1 class="text-capitalize text-lg">Blog Single</h1>
                        <ul class="list-inline breadcumb-nav">
                            <li class="list-inline-item"><a href="{{ url('/') }}" class="text-white">Home</a></li>
                            <li class="list-inline-item"><span class="text-white"><i class="icofont-arrow-right"></i></span>
                            </li>
                            <li class="list-inline-item"><a href="{{ route('blog.details', $blogInfo->slug) }}"
                                    class="text-white-50">{{ $blogInfo->title }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-5">
                            <div class="single-blog-item">
                                <img src="{{ asset($blogInfo->featured_image) }}" alt="" class="img-fluid">

                                <div class="blog-item-content mt-5">
                                    <div class="blog-item-meta mb-3">
                                        <span class="text-color-2 text-capitalize mr-3"><i
                                                class="icofont-book-mark mr-2"></i> {{ $blogInfo['category']['name'] }}</span>
                                        ...
                                        <span class="text-black text-capitalize mr-3"><i class="icofont-calendar mr-2"></i>
                                            {{ date('j \\ F Y', strtotime($blogInfo->created_at)) }}</span>
                                    </div>
                                    ...
                                    <div class="mt-5 clearfix">
                                        <ul class="float-left list-inline tag-option">
                                            ...
                                            @foreach ($categories as $category)
                                                <li class="list-inline-item"><a href="#!">{{ $category->name }}</a>
                                                </li>
                                            @endforeach
                                    ...
                                    <li class="mb-5">
                                        <div class="comment-area-box d-block d-sm-flex">
                                            <div class="comment-thumb">
                                                <img alt=""
                                                    src="{{ asset('frontend/images/blog/testimonial1.jpg') }}"
                                                    style="width: 70px">
                                            </div>
                ...
                <div class="col-lg-4">
                    <div class="sidebar-wrap pl-lg-4 mt-5 mt-lg-0">
                        ...
                        <div class="sidebar-widget latest-post mb-3">
                            ...
                            @php
                                $blogs = App\Models\Blog::where('slug', '!=', $blogInfo->slug)->get();
                            @endphp
                            @foreach ($blogs as $blog)
                                <div class="py-2">
                                    <span
                                        class="text-sm text-muted">{{ date('j \\ F Y', strtotime($blog->created_at)) }}</span>
                                    <h6 class="my-2"><a
                                            href="{{ route('blog.details', $blog->slug) }}">{{ $blog->title }}</a></h6>
                                </div>
                            @endforeach
                            ...
                            <ul class="list-unstyled">
                                @foreach ($categories as $category)
                                    <li class="align-items-center">
                                        <a href="{{ route('category.wise.blog', $category->id) }}"
