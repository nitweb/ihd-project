            ...
            <ul class="header-megamenu nav">
                                    ...
                                    <div class="no-gutters row">
                                        ...
                                        <div class="col-sm-6 col-xl-4">
                                            <ul class="nav flex-column">
                                                ...
                                                <li class="nav-item">
                                                    <a href="javascript:void(0);" class="nav-link"> Reports Conversions
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                ...
                <li class="dropdown nav-item">
                    ...
                    <div tabindex="-1" role="menu" aria-hidden="true"
                        class="dropdown-menu-rounded dropdown-menu-lg rm-pointers dropdown-menu" style="">
                        <div class="dropdown-menu-header">
                ...
                <div class="widget-content p-0">
                    <div class="widget-content-wrapper">
                        ...
                        <div class="widget-content-left  ml-3 header-user-info">
                            <div class="widget-heading">{{ $adminData->name }} </div>
                            <div class="widget-subheading"> {{ $adminData->email }} </div>
                        </div>
                                                    ...
                                                    <div class="widget-content-left">
                                                        <div class="widget-subheading opacity-8">
                                                            <a href="{{ route('admin.profile') }}"
                                                                class="d-block text-light">Profile</a>
                                                            <a href="{{ route('change.admin.password') }}"
                                                                class="d-block text-light">Change
                                                                Password</a>
                                                            <a href="{{ route('admin.logout') }}"
                                                                class="d-block text-light">Logout</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
