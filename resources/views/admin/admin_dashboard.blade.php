...
<body>
    ...
    <script type="text/javascript" src="{{ asset('admin-backend/assets/scripts/all.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('admin-backend/assets/scripts/fontawesome.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('admin-backend/assets/scripts/main.js') }}"></script>
    <script type="text/javascript" src="{{ asset('admin-backend/assets/scripts/code.js') }}"></script>
