                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img class="img-profile" width="100"
                                                    src="{{ !empty($about->about_image) ? url($about->about_image) : url('upload/no-image.jpg') }}"
                                                    id="show_image" alt="Profile Image">
                                            </td>
                                            <td class="d-flex"><a
                                                    href="{{ route('edit.about', $about->id) }}" class="btn btn-info"><i
                                                        class="fas fa-edit"></i></a> <a style="margin-left: 5px;"
                                                    id="delete" href="{{ route('delete.about', $about->id) }}"
