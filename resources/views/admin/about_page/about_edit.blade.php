                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('update.about') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id" value="{{ $aboutInfo->id }}">
                            <div class="row mb-3">
                                <div class="col-12 text-secondary">
                                    <label for="">About Info</label>
                                    <textarea name="short_info" id="tiny"> {!! $aboutInfo->short_info !!}</textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-12 text-secondary">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <img class="img-profile" width="100"
                                            src="{{ !empty($aboutInfo->about_image) ? url($aboutInfo->about_image) : url('upload/no-image.jpg') }}"
